...
- `list_dependencies`, `impact_analysis`, `find_references` `to`, and call resolution no longer link a `.h` include to a same-named `.hpp` or a bare JavaScript package specifier to a project file.
